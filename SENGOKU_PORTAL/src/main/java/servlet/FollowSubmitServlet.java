...
/**
 * Servlet implementation class FollowSubmitServlet
 */
@WebServlet("/FollowSubmitServlet")
public class FollowSubmitServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FollowSubmitServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			count = followdao.follow(my_user_id, other_user_id);
