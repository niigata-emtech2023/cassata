...
<body>
	...
	<div class="jsp-main-contents">
		...
		<div class="Form">
			...
			<div class="Form-Item">
			   <p class="Form-Item-Label">
			     <span class="Form-Item-Label-Required">必須</span><span class="formHead">現在のパスワード</span>
			   </p>
			   <input type="password" name="current_password" class="Form-Item-Input" placeholder="半角英数字、16文字以内" pattern="^[0-9a-zA-Z]+$" maxlength="16" required>
			</div>
